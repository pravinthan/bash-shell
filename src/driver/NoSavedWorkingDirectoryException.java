...
public class NoSavedWorkingDirectoryException extends Exception {

  /**
   * Creates an instance of NoSavedWorkingDirectoryException
   *
   * @param message is a string that is shown when the exception is thrown
   */
  public NoSavedWorkingDirectoryException(String message) {
    // Pass exception message to super constructor
    super(message);
  }
}
